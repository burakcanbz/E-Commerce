                    ...
                    >
                        <Box sx={{ maxWidth: 800, mx: "auto" }}>
                            ...
                            >
                                ...
                                <rect x="320" y="390" width="160" height="16" rx="4" fill="#d0d7ea" />
                                <rect x="360" y="410" width="80" height="12" rx="6" fill="#cfd8e9" />
                            </svg>
                        </Box>
                        ...
                        <Typography variant="body1" color="textSecondary" sx={{ mb: 2, mt: 1 }}>
                            We encountered an unexpected error. Try refreshing or come back later.
                        </Typography>
