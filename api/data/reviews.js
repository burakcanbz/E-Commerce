const reviews = [
  ...
  { rating: 4, comment: "Very good product.", createdAt: new Date("2023-10-05").toLocaleDateString('en-CA').split('T')[0] },
  { rating: 2, comment: "Not great, but okay.", createdAt: new Date("2023-10-05").toLocaleDateString('en-CA').split('T')[0] },
  { rating: 4.5, comment: "Really enjoyed this product!", createdAt: new Date("2023-10-05").toLocaleDateString('en-CA').split('T')[0] },
];
